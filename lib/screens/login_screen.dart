...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _onLogin() async {
    ...
    try {
      ...
      //   const SnackBar(content: Text("Login success (demo)")),
      // );
      //MyUtility.replacePage(context, ProfileSetupScreen());
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> loginUser() async {
    ...
    // AuthData authData = await apiCall.login(
    //     _emailCtrl.text.toString(), _passCtrl.text.toString());
    // if (authData.success!) {
    //   print(authData.data!.token!);
    //   // FlutterSecureStorage storage = FlutterSecureStorage();
    //   // storage.write(key: "token", value: authData.data!.token!);
    //   SharedPreferences preferences = await SharedPreferences.getInstance();
    //   preferences.setString("token", authData.data!.token!);
    //   preferences.setString("name", authData.data!.name!);
    //   preferences.setString("email", authData.data!.email!);
    // }
  }
}
